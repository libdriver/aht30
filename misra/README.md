...
| --------- | ------------------------------------------------------------ | ------------ | ------------------------------------------------------------ | -------- |
| 10.1      | Operands shall not be of an inappropriate essential type. (\|, &, ~, <<, >>) | incompatible | We use this function to convert driver data and drivers guarantee the safety of the operation. | very low |
...
Detailed reports can be found in /misra/aht30_polyspace_report.pdf.
